  ...
  "pathParams": [
    {
      ...
      "type": "string",
      "required": true,
      "description": "The unique identifier of the contact snapshot to retrieve."
    }
  ],
  "queryParams": [
    {
    ...
    },
    {
      ...
      "type": "array",
      "required": false,
      "description": "A case-insensitive query parameter that specifies the sort order of the list, which can be either ascending (e.g. `accountnumber.ASC`) or descending (e.g. `accountnumber.DESC`). You cannot sort on properties in arrays. If the array-type properties are specified for the `sort[]` parameter, they are ignored. The fields that can be sorted include: - id - updateddate - contactid",
      "itemType": "string"
    },
    {
      "name": "expand[]",
    ...
    },
    {
      ...
      "type": "array",
      "required": false,
      "description": "A case-insensitive filter on the list. The available options include: - id - updateddate - contactid - {indexedcustomfield}",
      "itemType": "string"
    },
    {
      "name": "fields[]",
