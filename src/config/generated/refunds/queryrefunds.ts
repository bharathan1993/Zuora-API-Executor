...
export const queryrefundsEndpoint: ApiEndpoint = {
  "id": "queryrefunds",
  "name": "List refunds",
  "description": "Lists Refund objects. You can use the query parameters to filter, expand, and sort the returned results.",
  "method": "GET",
  ...
  "queryParams": [
    ...
    },
    {
      ...
      "type": "array",
      "required": false,
      "description": "A case-insensitive filter on the list. Supported filterable fields: - id - updateddate - accountid - paymentmethodsnapshotid - amount - paymentmethodid - reasoncode - refunddate - refundnumber - sourcetype - status - type - {indexedcustomfield}: Use the format like `customField__c` to filter on custom fields.",
      "itemType": "string"
    },
    {
      "name": "fields[]",
