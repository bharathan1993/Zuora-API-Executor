...
export const put_writeoffinvoiceEndpoint: ApiEndpoint = {
  ...
  "bodyFields": [
    ...
    },
    {
      ...
      "type": "array",
      "required": false,
      "description": "Container for items. This field is optional. **Note:** * If specified, you must specify ALL the items of the invoice. The entire balance of the invoice will be written off, you cannot just write off some items of the invoice. * This field is available only if you have enabled the enhanced write-off permission for your tenant. Contact Zuora Global Support to enable this permission.",
      "itemType": "object",
      "itemFields": [
        {
          "name": "comment",
        ...
        },
        {
          ...
          "type": "number",
          "required": false,
          "description": "The write off amount of the invoice item excluding tax.",
    ...
    },
    {
      ...
      "type": "number",
      "required": false,
      "description": "The write off amount of the invoice. **Note**: This field is available only if you have enabled the enhanced write-off permission for your tenant. Contact Zuora Global Support to enable this permission.",
      "section": "Additional Fields"
    },
    {
      "name": "reasonCode",
