...
export const queryinvoicesEndpoint: ApiEndpoint = {
  "id": "queryinvoices",
  "name": "List invoices",
  "description": "Lists invoices. You can use the query parameters to filter, expand, and sort the returned results.",
  "method": "GET",
  ...
  "queryParams": [
    ...
    },
    {
      ...
      "type": "array",
      "required": false,
      "description": "A case-insensitive filter on the list. Supported filterable fields: - id - updateddate - accountid - amount - balance - duedate - invoicedate - invoicenumber - reversed - sourceid - sourcetype - status - einvoicestatus - {indexedcustomfield}: Use the format like `customField__c` to filter on custom fields.",
      "itemType": "string"
    },
    {
      "name": "fields[]",
