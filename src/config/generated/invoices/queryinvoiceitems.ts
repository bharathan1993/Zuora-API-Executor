...
export const queryinvoiceitemsEndpoint: ApiEndpoint = {
  ...
  "queryParams": [
    ...
    },
    {
      ...
      "type": "array",
      "required": true,
      "description": "A case-insensitive filter on the list. Supported filterable fields: - id - updateddate - rateplanchargeid - invoiceid - accountingcode - chargedate - chargenumber - excludeitembillingfromrevenueaccounting - fulfillmentid - servicestartdate - serviceenddate - sourceitemtype - subscriptionid - subscriptionnumber - productrateplanchargeid - bookingreference - {indexedcustomfield}: Use the format like `customField__c` to filter on custom fields.",
      "itemType": "string"
    },
    {
      "name": "fields[]",
