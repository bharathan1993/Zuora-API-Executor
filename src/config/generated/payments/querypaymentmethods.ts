...
export const querypaymentmethodsEndpoint: ApiEndpoint = {
  ...
  "description": "Lists payment methods. You can use the query parameters to filter, expand, and sort the returned results.",
  "method": "GET",
