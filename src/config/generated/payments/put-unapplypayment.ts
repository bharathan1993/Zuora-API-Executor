  ...
  "bodyFields": [
    {
      ...
      "itemFields": [
        ...
        },
        {
          ...
          "type": "string",
          "required": false,
          "description": "The unique ID of the debit memo that the payment is unapplied from. **Note:** - The Payment Cross Account (PCA) feature is in the Early Adopter phase. - When PCA is enabled for the tenant, you can specify a debit memo / invoice that is different from the account that is specified in the request body.",
        ...
        },
        {
          ...
          "type": "string",
          "required": false,
          "description": "The number of the debit memo that the payment is unapplied from. **Note:** - The Payment Cross Account (PCA) feature is in the Early Adopter phase. - When PCA is enabled for the tenant, you can specify a debit memo / invoice that is different from the account that is specified in the request body.",
    ...
    },
    {
      ...
      "itemFields": [
        ...
        },
        {
          ...
          "type": "string",
          "required": false,
          "description": "The unique ID of the invoice that the payment is unapplied from. **Note:** - The Payment Cross Account (PCA) feature is in the Early Adopter phase. - When PCA is enabled for the tenant, you can specify a debit memo / invoice that is different from the account that is specified in the request body.",
