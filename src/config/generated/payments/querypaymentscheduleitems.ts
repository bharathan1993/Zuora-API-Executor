...
export const querypaymentscheduleitemsEndpoint: ApiEndpoint = {
  ...
  "queryParams": [
    ...
    },
    {
      ...
      "type": "array",
      "required": false,
      "description": "Allows you to expand responses by including related object information in a single call. The Payment Schedule Item object does not support expanding any related objects.",
      "itemType": "string",
      "itemEnum": [
    ...
    },
    {
      ...
      "type": "array",
      "required": false,
      "description": "A case-insensitive filter on the list. Supported filterable fields: - id - updateddate - number - accountid - invoiceid - debitmemoid - paymentscheduleid - scheduleddate - status - paymentid - cancellationreason - {indexedcustomfield}: Use the format like `customField__c` to filter on custom fields.",
      "itemType": "string"
    },
    {
      "name": "fields[]",
