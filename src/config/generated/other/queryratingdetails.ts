...
export const queryratingdetailsEndpoint: ApiEndpoint = {
  ...
  "queryParams": [
    ...
    },
    {
      ...
      "type": "array",
      "required": false,
      "description": "A case-insensitive query parameter that specifies the sort order of the list, which can be either ascending (e.g. `id.ASC`) or descending (e.g. `id.DESC`). Supported sortable fields: - `id` - `invoiceitemid` - `creditmemoitemid`",
      "itemType": "string"
    },
    {
      "name": "expand[]",
      ...
      "type": "array",
      "required": false,
      "description": "Allows you to expand responses by including related object information in a single call. This operation does not have expandable fields.",
      "itemType": "string"
    },
    {
      "name": "filter[]",
      ...
      "type": "array",
      "required": false,
      "description": "A case-insensitive filter on the list. Supported filterable fields: - `id` - `invoiceitemid` - `creditmemoitemid` You can also filter on custom fields using the format `customField__c`.",
      "itemType": "string"
    },
    {
      "name": "fields[]",
