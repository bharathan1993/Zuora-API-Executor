...
export const querybillingrunsEndpoint: ApiEndpoint = {
  ...
  "queryParams": [
    ...
    },
    {
      ...
      "type": "array",
      "required": false,
      "description": "Allows you to expand responses by including related object information in a single call. The Bill Run object does not support expanding any related objects.",
      "itemType": "string"
    },
    {
      "name": "filter[]",
      ...
      "type": "array",
      "required": false,
      "description": "A case-insensitive filter on the list. Supported filterable fields: - id - createdbyid - updateddate - billingrunnumber - executeddate - name - numberofaccounts - numberofinvoices - numberofcreditmemos - status - targetdate - batches - repeattype - {indexedcustomfield}: Use the format like `customField__c` to filter on custom fields.",
      "itemType": "string"
    },
    {
      "name": "fields[]",
