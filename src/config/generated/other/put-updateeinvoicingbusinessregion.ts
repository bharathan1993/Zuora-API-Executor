...
export const put_updateeinvoicingbusinessregionEndpoint: ApiEndpoint = {
  ...
  "bodyFields": [
    ...
    },
    {
      ...
      "type": "array",
      "required": false,
      "description": "You can define the file format for each business category as shwown in the following example: fileFormat\" : { \"B2B\" : [ \"XML\" ], \"B2C\" : [ ], \"B2G\" : [ \"XML\" ] } **Note:** This field is optional; however, if you use Avalara integration, it becomes a mandatory field.",
      "itemType": "string",
      "section": "Additional Fields"
    },
    {
