    ...
    },
    {
      ...
      "itemFields": [
        ...
        },
        {
          ...
          "type": "string",
          "required": false,
          "description": "Options for aligning the commitment periods within a commitment.\n",
        ...
        },
        {
          ...
          "type": "string",
          "required": false,
          "description": "The accounting code on the commitment for customers.\n\n\n**Notes:** This field is only available if you have the <a href=\"https://docs.zuora.com/en/zuora-billing/set-up-zuora-billing/enable-order-to-revenue/overview-of-order-to-revenue\" target=\"_blank\">Order to Revenue</a> feature enabled. \n",
          "maxLength": 100,
          "section": "Account Settings"
        },
        {
        ...
        },
        {
          ...
          "type": "boolean",
          "required": false,
          "description": "The flag to exclude commitment related invoice items, invoice item adjustments, credit memo items, and debit memo items from revenue accounting.\n\n\n**Note:** This field is only available if you have the <a href=\"https://docs.zuora.com/en/zuora-billing/set-up-zuora-billing/enable-order-to-revenue/overview-of-order-to-revenue\" target=\"_blank\">Order to Revenue</a> feature enabled. \n",
          "section": "Account Settings"
        },
        {
          ...
          "type": "boolean",
          "required": false,
          "description": "This field is used to identify if the commitment is allocation eligible in revenue recognition.\n\n\n**Note:** This field is only available if you have the <a href=\"https://docs.zuora.com/en/zuora-billing/set-up-zuora-billing/enable-order-to-revenue/overview-of-order-to-revenue\" target=\"_blank\">Order to Revenue</a> feature enabled. \n",
          "section": "Additional Fields"
        },
        {
          "name": "isUnbilled",
        ...
        },
        {
          ...
          "type": "string",
          "required": false,
          "description": "This field is used to dictate the type of revenue amortization method.\n",
          "maxLength": 200,
          "section": "Additional Fields"
        },
        {
        ...
        },
        {
          ...
          "type": "string",
          "required": false,
          "description": "This field is used to dictate the type of revenue recognition timing.\n",
          "maxLength": 200,
          "section": "Additional Fields"
        },
        {
        ...
        },
        {
          ...
          "type": "boolean",
          "required": false,
          "description": "The flag to indicate whether the charge is taxable. If this field is set to `true`, both the fields `taxCode` and `taxMode` are required.\n",
          ...
          "fields": [
            {
              ...
              "type": "string",
              "required": false,
              "description": "The field name of a single condition.\n",
              "section": "Additional Fields"
            },
            {
              "name": "operator",
            ...
            },
            {
              ...
              "type": "array",
              "required": false,
              "description": "The conditions will be combined by the relation.\n",
              "section": "Additional Fields"
            },
            {
              "name": "relation",
              ...
              "type": "string",
              "required": false,
              "description": "The relation among the conditions.\n",
              "enum": [
                "and",
                "or"
              ],
        ...
        },
        {
          ...
          "type": "string",
          "required": true,
          "description": "The action type of the commitment.\n",
          "enum": [
            "create",
            "update"
          ],
        ...
        },
        {
          ...
          "type": "object",
          "required": false,
          "description": "Upsert an schedule, when the action is create, create a new schedule, when the action is update, update the schedule.",
          "fields": [
            {
              "name": "amount",
              "label": "Amount",
            ...
            },
            {
              ...
              "type": "string",
              "required": false,
              "description": "The frequency type of the period of the commitment schedule.\n",
              "defaultValue": "Month",
              "enum": [
                "Month",
                "Quarter",
            ...
            },
            {
              ...
              "type": "string",
              "required": true,
              "description": "The action type of the schedule.\n",
              "enum": [
                "create",
                "update"
              ],
              ...
              "fields": [
                {
                  ...
                  "itemFields": [
                    ...
                    },
                    {
                      ...
                      "type": "array",
                      "required": false,
                      "description": "Array of negotiated price table information. The rate card entries provided in the array will override the existing rate card entries in the standard price table to form a negotiated price table that will be used during pricing evaluation.\n\n\n**Note:** To enable the Negotiated Price Table feature, submit a request to <a href=\"https://support.zuora.com/\" target=\"_blank\">Zuora Global Support</a>.                     \n",
                      "itemType": "object",
                      "itemFields": [
                        {
                          "name": "items",
