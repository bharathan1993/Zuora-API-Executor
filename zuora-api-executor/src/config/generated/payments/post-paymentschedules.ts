        ...
        },
        {
          ...
          "fields": [
            ...
            },
            {
              ...
              "type": "string",
              "required": false,
              "description": "Number of the billing document.\n\n**Note:**\n If a billing document is specified, either `id` or `number` of the billing document must be specified. You cannot specify both of them or skip both.\n",
              "section": "Account Settings"
            },
            {
              "name": "type",
        ...
        },
        {
          ...
          "itemFields": [
            ...
            },
            {
              ...
              "type": "string",
              "required": false,
              "description": "Number of the billing document. If the billing document is a debit memo, it contains the debit memo number. If the billing document is an invoice, it contains the invoice number.\n\n**Note:** If a billing document is specified, either `id` or `number` of the billing document must be specified. You cannot specify both of them or skip both.\n",
              "section": "Account Settings"
            },
            {
              "name": "type",
