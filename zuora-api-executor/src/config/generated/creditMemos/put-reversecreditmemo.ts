...
export const put_reversecreditmemoEndpoint: ApiEndpoint = {
  ...
  "bodyFields": [
    ...
    },
    {
      ...
      "type": "string",
      "required": false,
      "description": "A code identifying the reason for the reversal. The value must be an existing reason code or empty. The code is used as the reason code of the debit memo generated by reversing the specified credit memo.\n\nIf you do not specify a value, Zuora uses the default reason code `Credit memo reversal` for the debit memo.\n",
      "section": "Additional Fields"
    }
  ],
  "headers": {
