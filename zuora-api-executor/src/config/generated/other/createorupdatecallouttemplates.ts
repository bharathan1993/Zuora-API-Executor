  ...
  "bodyFields": [
    {
      ...
      "type": "boolean",
      "required": false,
      "description": "When set to `false`, the call will fail if one or multiple instances fail to import, and a `200` response is returned if all callout templates have been successfully updated.\nWhen set to `true`, a success (`200`) response is returned if one or more instances have imported successfully. All failed instances are also returned in the response.\n",
    ...
    },
    {
      ...
      "type": "array",
      "required": false,
      "description": "A container for callout templates.\n",
      "itemType": "object",
      "itemFields": [
        {
          "name": "active",
        ...
        },
        {
          ...
          "type": "string",
          "required": false,
          "description": "ID of an existing callout template. Specify this field if you want to update an existing callout template.\n",
          "section": "Additional Fields"
        },
        {
          "name": "name",
