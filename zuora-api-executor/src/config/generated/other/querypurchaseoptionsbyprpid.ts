  ...
  "bodyFields": [
    {
      ...
      "type": "array",
      "required": false,
      "description": "Defines the filtering criteria for querying purchase options or product rate plans.\nEach filter includes a target field, an operator, and a value.\n",
      "itemType": "object",
      "itemFields": [
        {
          "name": "field",
        ...
        },
        {
          ...
          "type": "string",
          "required": true,
          "description": "Comparison operator. Supported values:\n- `EQ`  (equals)\n- `NE`  (not equals)\n- `LT`  (less than)\n- `GT`  (greater than)\n- `SW`  (starts with)\n- `EW`  (ends with)\n- `IN`  (in list)\n- `LIKE` (partial match)\n",
          "enum": [
            "EQ",
            "NE",
            "LT",
    ...
    },
    {
      ...
      "type": "string",
      "required": false,
      "description": "Optional identifier for a specific Product Rate Plan Charge (PRPC) to query.\nCan be either a PRPC ID or a PRPC number/key.\n",
      "section": "Additional Fields"
    },
    {
      "name": "attributes",
